                    ...
                    <div className="inner-box">
                        ...
                        <div className="info">
                            ...
                            <div className="start-date" >
                                <input className="date1" type="date" id="sdate" onChange={(e)=>setDate1(e.target.value)}  disabled={readType==='true'?true:false} />   
                            </div>
                            <div className="end-date" >
                                <input className="date2" type="date" min={startDate} id="enddate" onChange={(e)=>setDate2(e.target.value)} disabled={readType==='true'?true:false}/>  
                            </div>
                            <div className="seek-bar">
                            <input type="range" className="seekbar" min="1" max="5" step= "1" defaultValue="1" class="slider" id="myRange" onChange={(e)=>setSeek(e.target.value)} disabled={readType==='true'?true:false}/> {seek}
