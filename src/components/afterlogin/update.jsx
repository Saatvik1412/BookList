                        ...
                        <div className="inner-box">
                            ...
                            <div className="info">
                                ...
                                <div className="start-date" >
                                    <input className="date1" type="date" id="sdate" defaultValue={startDate1} onChange={(e)=>{setDate1(e.target.value);}}  disabled={readType==='true'?true:false} />   
                                </div>
                                <div className="end-date" >
                                    <input className="date2" type="date" min={startDate1}  defaultValue={endDate1} id="enddate" onChange={(e)=>{setDate2(e.target.value);}} disabled={readType==='true'?true:false}/>  
                                </div>
                                <div className="seek-bar">
                                <input type="range" className="seekbar" min="1" max="5" step= "1" defaultValue={item.rating} class="slider" id="myRange" onChange={(e)=>setSeek(e.target.value)} disabled={readType==='true'?true:false}/> {seek}
